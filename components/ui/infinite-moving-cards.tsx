        ...
        {items.map((item, idx) => (
          ...
          >
            <Link
              ...
              target="_blank"
              rel="noopener"
              className="flex flex-col items-start justify-between relative rounded-xl border hover:border-sky-500 bg-white dark:bg-zinc-800 shadow-xl hover:shadow-sky-200 dark:hover:shadow-sky-800 w-full h-full"
            >
